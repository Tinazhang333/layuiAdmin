...
layui.define(['table', 'form'], function(exports){
  ...
  //评论管理
  table.render({
    elem: '#LAY-app-content-comm0'
    ,url: './json/content/comment.js' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 100, title: 'ID', sort: true}
      ,{field: 'reviewers', title: '姓名', minWidth: 100}
      ,{field: 'content', title: '购买套餐', minWidth: 100}
      ,{field: 'commtime', title: '购买时间', minWidth: 100, sort: true}
      ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-content-com0'}
    ]]
    ,page: true
    ,limit: 10
    ,limits: [10, 15, 20, 25, 30]
  ...
  //ping1
  table.render({
    elem: '#LAY-app-content-comm1'
    ,url: './json/content/comment1.js' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 100, title: 'ID', sort: true}
      ,{field: 'reviewers', title: '姓名', minWidth: 100}
      ,{field: 'content', title: '购买套餐', minWidth: 100}
      ,{field: 'commtime', title: '购买时间', minWidth: 100, sort: true}
      ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-content-com1'}
    ]]
    ,page: true
    ,limit: 10
    ,limits: [10, 15, 20, 25, 30]
  ...
  table.render({
    ...
    ,url: './json/content/comment2.js' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 100, title: 'ID', sort: true}
      ,{field: 'reviewers', title: '姓名', minWidth: 100}
      ,{field: 'content', title: '购买套餐', minWidth: 100}
      ,{field: 'commtime', title: '购买时间', minWidth: 100, sort: true}
      ,{title: '操作', width: 150, align: 'center', fixed: 'right', toolbar: '#table-content-com2'}
    ]]
    ,page: true
    ,limit: 10
    ,limits: [10, 15, 20, 25, 30]
